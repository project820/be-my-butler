...
7. **Consultant language**: en / ko / ja / zh-TW (default: en)
   - Sets the language for all user-facing communication from the Consultant and Lead
8. **Consultant style**: default / custom
   - If custom: ask for description (e.g., "explain like I'm a high schooler", "use construction analogies")
9. **Telegram notifications**: enabled / disabled (default: disabled)
