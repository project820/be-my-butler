...
```bash
INIT=$(node /Users/dayum_gud/.claude/get-shit-done/bin/gsd-tools.cjs state load)
...
```bash
node /Users/dayum_gud/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
